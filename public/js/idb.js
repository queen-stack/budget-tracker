...
// This function will be executed if you attempt to submit a new transaction and there is no internet connection
function saveRecord(record) {
    ...
    const budgetObjStore = transaction.objectStore('new_transaction');
        ...
        if (getAll.result.length > 0) {
            fetch('/api/transaction', {
                ...
                .then(serverResponse => {
                    ...
                    alert('All saved transactions have now been submitted!');
                })
                .catch(err => {
                    console.log(err);
                });
